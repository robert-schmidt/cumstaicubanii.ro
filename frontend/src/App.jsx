      ...
      <header className="border-b border-slate-200 bg-white/80 backdrop-blur sticky top-0 z-10">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2 group">
            <span className="inline-flex w-8 h-8 rounded-lg bg-slate-900 items-center justify-center">
        ...
        <div className="max-w-6xl mx-auto px-4 py-6 text-xs text-slate-500 space-y-2">
          <div className="flex flex-col sm:flex-row gap-2 sm:items-center sm:justify-between">
            ...
            <a
              ...
              className="inline-flex items-center gap-1 px-3 py-1.5 rounded-full bg-amber-50 text-amber-700 border border-amber-200 hover:bg-amber-100 transition"
            >
              ☕ Buy me a coffee
            </a>
          </div>
          <p className="text-slate-400 flex flex-col sm:flex-row gap-1 sm:items-center sm:justify-between">
            <span>© cumstaicubanii.ro — reproducerea fără acordul explicit sau menționarea în clar a sursei este interzisă.</span>
            <a
              href="https://github.com/robert-schmidt/cumstaicubanii.ro"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1 text-slate-400 hover:text-slate-600 transition"
